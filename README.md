...
| `rtl` | `boolean` | `false` | Whether the Snackbar should render right-to-left (for android it is requires `android:supportsRtl="true"`, see [setup guide](https://android-developers.googleblog.com/2013/03/native-rtl-support-in-android-42.html) and [example app](/example)). |
